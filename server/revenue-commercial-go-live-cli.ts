...
export function buildRevenueCommercialGoLivePacket(options: RevenueCommercialGoLiveCliOptions) {
  ...
  const requiredEnvironment = [
    ...
    {
      group: "Money mode",
      names: ["REVENUE_ENGINE_MONEY_MODE", "REVENUE_ENGINE_DEPLOY_APPROVED_BY_ROBERT", "REVENUE_ENGINE_DEPLOY_APPROVAL_EVIDENCE"],
      reason: "Explicit launch switch and durable Robert deployment approval evidence.",
    },
    {
    ...
    },
    {
      ...
      reason: "PR, preview deploy, QA report, rollback proof and Robert approval evidence before publishing client websites.",
    },
  ];

...
const workItems: readonly AiMediaStudioAgentWorkItem[] = [
  ...
  },
  {
    ...
    nextAction: "Finish and review the roster-plan bridge, then request separate approval for one named restored-staging rehearsal; do not apply SQL automatically.",
  },
  {

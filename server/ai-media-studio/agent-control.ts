...
const workItems: readonly AiMediaStudioAgentWorkItem[] = [
  ...
  },
  {
    ...
    mergeGate: "Focused route and persistence tests, typecheck/build, independent checker and App QA must pass before a PR is ready for review.",
    evidence: [
      "A separate PR-first branch isolates roster mutation hardening from held-admission work",
    ],
    blockers: [
      "Implementation and maker verification are still in progress",
      "Pull request URL remains unset until the root agent opens the reviewed draft PR",
      "Live HeyGen calls, spend, publishing, migrations and deployment remain unauthorized",
    ],
    nextAction: "Harden the roster mutation boundary, prove rejection occurs before persistence, then run independent checker and App QA before opening the draft PR.",
  },
  {

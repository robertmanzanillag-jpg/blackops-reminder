...
const workItems: readonly AiMediaStudioAgentWorkItem[] = [
  ...
  },
  {
    ...
    evidence: ["PR30 no-go staging runbook prepared", "Exact 19-file forward/reverse inventory is statically tested", "Full AI Media Studio suite: 669 passed, 0 failed, 24 PostgreSQL-only skipped (693 total)", "Independent SQL checker and App QA recheck: P0=P1=P2=0"],

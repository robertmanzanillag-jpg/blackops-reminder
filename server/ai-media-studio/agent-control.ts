...
const workItems: readonly AiMediaStudioAgentWorkItem[] = [
  ...
  },
  {
    ...
    blockers: ["GitHub draft PR checkpoint is not created yet; merge, migration, sandbox, spend and deployment remain separately blocked"],
    nextAction: "Preserve this reviewed checkpoint in a draft PR stacked on #131 without merging, applying migrations or activating HeyGen.",
  },
  {

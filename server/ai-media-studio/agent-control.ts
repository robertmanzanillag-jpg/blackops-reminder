...
const workItems: readonly AiMediaStudioAgentWorkItem[] = [
  ...
  },
  {
    ...
    blockers: ["Commit, push and the stacked draft GitHub PR checkpoint are still required", "The inherited Clippers chunk warning blocks deployment only; no deployment is requested"],
    nextAction: "Create the stacked draft GitHub checkpoint while generation, spend, provider calls and deployment remain disabled.",
  },
  {

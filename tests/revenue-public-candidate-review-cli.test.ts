  ...
  const output = formatRevenuePublicCandidateReviewText({
    ...
    moneySprintRunPacket: {
      ...
      requestBody: {
        ...
        reviewPacketEvidence: writePublicVerificationFixture("review-cafe"),
      },
      expectedOutput: {
        acceptedLeads: 1,
        mockupsToPrepare: 1,
    ...
    candidates: [
      {
        ...
        publicEvidenceVerificationRef: writePublicVerificationFixture(
          "cli-review-packet-cafe",
          "CLI Review Packet Cafe https://example.com/cli-review-packet-cafe owner@clireviewpacket.example",
        ),
    ...
    candidates: [
      {
        ...
        publicEvidenceVerificationRef: writePublicVerificationFixture(
          "cli-missing-id-cafe",
          "CLI Missing Id Cafe https://example.com/cli-missing-id-cafe owner@climissingid.example",
        ),
        publicEvidenceVerifiedBy: "robert",
        approvalToImport: true,
      },

...
const trackedEnvKeys = [
  ...
  "REVENUE_ENGINE_WEBSITE_PR_EVIDENCE",
  "REVENUE_ENGINE_WEBSITE_APP_QA_TARGET_PASSED",
  "REVENUE_ENGINE_WEBSITE_APP_QA_EVIDENCE",
  "REVENUE_ENGINE_WEBSITE_PREVIEW_DEPLOY_VERIFIED",
  "REVENUE_ENGINE_WEBSITE_PREVIEW_EVIDENCE",
  "REVENUE_ENGINE_WEBSITE_ROLLBACK_VERIFIED",
  "REVENUE_ENGINE_WEBSITE_ROLLBACK_EVIDENCE",
  "REVENUE_ENGINE_WEBSITE_PUBLISH_APPROVED_BY_ROBERT",
  "REVENUE_ENGINE_WEBSITE_PUBLISH_APPROVAL_EVIDENCE",
  "REVENUE_ENGINE_DEPLOY_APPROVED_BY_ROBERT",
  "REVENUE_ENGINE_DEPLOY_APPROVAL_EVIDENCE",
] as const;
...
function ensureWebsiteEvidenceFiles() {
...
function productionReadyEnv(): Record<string, string> {
  ...
  return {
    ...
    REVENUE_ENGINE_WEBSITE_PR_EVIDENCE: "github-pr:robert/client-sites#17",
    REVENUE_ENGINE_WEBSITE_APP_QA_TARGET_PASSED: "true",
    REVENUE_ENGINE_WEBSITE_APP_QA_EVIDENCE: "revenue_workspace/app-qa/test-client-site-report.md",
    REVENUE_ENGINE_WEBSITE_PREVIEW_DEPLOY_VERIFIED: "true",
    REVENUE_ENGINE_WEBSITE_PREVIEW_EVIDENCE: "https://client-site-preview.replit.app",
    REVENUE_ENGINE_WEBSITE_ROLLBACK_VERIFIED: "true",
    REVENUE_ENGINE_WEBSITE_ROLLBACK_EVIDENCE: "revenue_workspace/rollback/test-client-site.md",
    REVENUE_ENGINE_WEBSITE_PUBLISH_APPROVED_BY_ROBERT: "true",
    REVENUE_ENGINE_WEBSITE_PUBLISH_APPROVAL_EVIDENCE: "codex-thread:robert-publish-approval-17",
    REVENUE_ENGINE_DEPLOY_APPROVED_BY_ROBERT: "true",
    REVENUE_ENGINE_DEPLOY_APPROVAL_EVIDENCE: "codex-thread:robert-deploy-approval-17",
  };
}
...
test("keeps first-sprint readiness distinct from commercial go-live", () => {
  applyEnv({
    ...
    REVENUE_ENGINE_WEBSITE_PR_EVIDENCE: undefined,
    REVENUE_ENGINE_WEBSITE_APP_QA_TARGET_PASSED: undefined,
    REVENUE_ENGINE_WEBSITE_APP_QA_EVIDENCE: undefined,
    REVENUE_ENGINE_WEBSITE_PREVIEW_DEPLOY_VERIFIED: undefined,
    REVENUE_ENGINE_WEBSITE_PREVIEW_EVIDENCE: undefined,
    REVENUE_ENGINE_WEBSITE_ROLLBACK_VERIFIED: undefined,
    REVENUE_ENGINE_WEBSITE_ROLLBACK_EVIDENCE: undefined,
    REVENUE_ENGINE_WEBSITE_PUBLISH_APPROVED_BY_ROBERT: undefined,
    REVENUE_ENGINE_WEBSITE_PUBLISH_APPROVAL_EVIDENCE: undefined,
    REVENUE_ENGINE_DEPLOY_APPROVED_BY_ROBERT: undefined,
    REVENUE_ENGINE_DEPLOY_APPROVAL_EVIDENCE: undefined,
  });
...
test("commercial go-live stays blocked when publish flags lack evidence refs", () => {
  const booleanOnlyEnv = {
    ...productionReadyEnv(),
    REVENUE_ENGINE_WEBSITE_PR_EVIDENCE: undefined,
    REVENUE_ENGINE_WEBSITE_APP_QA_EVIDENCE: undefined,
    REVENUE_ENGINE_WEBSITE_PREVIEW_EVIDENCE: undefined,
  ...
  assert.equal(packet.readiness.canBuildWebsites, false);
  assert.equal(packet.safety.commercialGoLiveReady, false);
  assert.ok(packet.readiness.blockedUntil.some((item) => item.includes("evidence")));
});

...
async function writeBlockedPrerequisiteSummary(prerequisiteFailures) {
  ...
  const summary = {
    ...
    totals: {
      ...
      waitingMetrics: 0,
      readyToImport: 0,
      evidenceMissingApproval: 0,
      evidenceMissingPublicUrl: 0,
      evidenceMissingMetrics: 0,
      evidenceReadyForImportPreview: 0,
      evidenceInvalid: 0,
      syncApplied: 0,
      conflicts: 0,
      waitingMetricoolWork: 0,
      metricool100Rows: 0,
      metricool100ReadyBatches: 0,
      metricool100SourceReadyBatches: 0,
      metricool100BlockedBatches: 0,
    },
    nextRow: null,
    blockedNextRow: null,
    operatorSteps: [

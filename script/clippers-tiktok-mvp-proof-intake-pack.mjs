...
function renderMarkdown(summary) {
  return [
    ...
    ...summary.lanes.map((lane) => [
      ...
      `- Metricool proof: replace the Metricool placeholder with a real public/non-secret Metricool URL or concrete Google Drive file/folder or Docs evidence URL.`,
...
async function main() {
  ...
  const summary = {
    ...
    guardrails: [
      ...
      "TikTok profile URLs must exactly match @sportsdailyclips and @memeradarclips.",
      "Metricool proof URLs must be real HTTPS metricool.com URLs or concrete Google Drive file/folder or Docs evidence URLs.",

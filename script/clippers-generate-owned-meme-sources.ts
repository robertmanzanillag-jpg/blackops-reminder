...
async function main() {
  ...
  await writeFile(evidencePath, [
    ...
    "",
    "covered_assets: memes-owned-01.mp4 through memes-owned-14.mp4",
    "",
    "These source videos are original generated assets created locally for Meme Radar.",
    "They include no third-party footage, no creator clips, no sports broadcasts, no streamer clips, no copyrighted music, no raw footage, no cookies, no tokens, no passwords, and no private screenshots.",

...
function requiredValueFor(field, lane) {
  ...
  if (field === "metricool_connection_proof_url") {
    return `Real HTTPS metricool.com proof that Metricool brand ${lane.metricoolBrandName} is connected to ${lane.handle}.`;
  }
...
function nextActionFor(field, lane) {
  ...
  if (field === "metricool_connection_proof_url") {
    return `Replace the Metricool proof placeholder for ${lane.metricoolBrandName} with a real metricool.com HTTPS URL, then keep metricool_notes at 20+ characters.`;
  }

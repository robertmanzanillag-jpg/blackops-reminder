...
| AMS-311 OAuth/vault control plane | Identity owner | PR #89 open | Durable state/PKCE policy, exact account binding, fenced callback saga and application-envelope-encrypted code/token adapters are preserved in stacked PR #89. Runtime wiring, hard IAM role separation, lifecycle/reconciler, target-selection contract, real connectors, refresh/revocation, routes and sandbox proof remain blocked |

...
| AMS-311 OAuth/vault control plane | Identity owner | PR #92 open | Durable state/PKCE policy, exact account binding, fenced callback saga, encrypted code/token adapters, cleanup obligations and infrastructure preflight are preserved in the stacked series through PR #92. Runtime wiring, effective IAM proof, target-selection contract, real connectors, refresh/revocation, routes and sandbox proof remain blocked |

...
| PR27 HeyGen terminal evidence | PR #112, `codex/ai-media-studio-heygen-terminal-evidence`, stacked on PR #109 | Draft / GitHub checkpoint under review | Unmounted HeyGen V3 submit/status adapter, provider-neutral terminal worker, function-only reconcile repository, fenced terminal checks and append-only events atomically release active capacity and enqueue completed MP4 ingest without refunding committed money. Focused 31/31, static SQL 6/6, isolated PG16 3/3 and TypeScript pass; final suite/checker/App QA are in progress. No route, timer, live provider call, migration apply, spend or deploy is enabled |

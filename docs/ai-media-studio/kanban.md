...
| PR21 authenticated authority issuers | `codex/ai-media-studio-authority-issuers`, stacked on PR #103 | Local checkpoint / review pending | Server-only capability-separated issuer service and append-only Drizzle repository derive DB identity/time, exact subject/evidence chains and immutable snapshots. An isolated socket-only PostgreSQL 16.14 harness passes 7/7 against the exact PR19/PR20 forward SQL. No route/barrel/runtime/provider/job/outbox/spend/deploy is enabled; production RBAC, durable launch intent, budget provisioning, scale counters, staging rehearsal and sandbox evidence remain gates |

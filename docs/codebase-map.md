...
Generated: 2026-06-29T07:57:01.241Z
...
| `server` | 93 | 90 | server:93 |
| `tests` | 57 | 54 | test:57 |
| `script` | 53 | 51 | script:53 |
| `.` | 25 | 17 | other:16, docs:8, package:1 |
| `docs` | 11 | 10 | docs:11 |
| `server/replit_integrations` | 8 | 8 | server:8 |
| `marketing_workspace` | 9 | 6 | docs:6, other:3 |
| `client/public` | 13 | 2 | other:13 |
| `marketing_workspace/video_intro` | 338 | 2 | other:338 |
| `.agents/skills` | 2 | 1 | docs:1, other:1 |
| `.upm` | 1 | 1 | other:1 |
| `client` | 1 | 1 | other:1 |
| `marketing_workspace/videos` | 6 | 1 | other:5, docs:1 |
...
- `script/clippers-account-permission-readiness.mjs` (script; 111 symbols, 2 imports)
...
- `script/clippers-metricool-current-batch-session-packet.mjs` (script; 39 symbols, 2 imports)
...
- `script/clippers-metricool-operator-handoff.mjs` (script; 148 symbols, 3 imports)
...
- `script/clippers-tiktok-batch-closeout-verifier.mjs` (script; 25 symbols, 2 imports)
- `script/clippers-tiktok-batch-evidence-sync.mjs` (script; 99 symbols, 4 imports)
- `script/clippers-tiktok-batch-runbook.mjs` (script; 54 symbols, 2 imports)
- `script/clippers-tiktok-batch-tracker.mjs` (script; 81 symbols, 4 imports)
...
- `script/clippers-tiktok-mvp-go-live-packet.mjs` (script; 43 symbols, 3 imports)
- `script/clippers-tiktok-mvp-readiness-verifier.mjs` (script; 26 symbols, 2 imports)
- `script/clippers-tiktok-next-action.mjs` (script; 30 symbols, 2 imports)
...
- `script/clippers-tiktok-post-schedule-verifier.mjs` (script; 20 symbols, 2 imports)
- `script/clippers-tiktok-preflight.ts` (script; 15 symbols, 1 imports)
- `script/codebase-map.ts` (script; 44 symbols, 3 imports)
...
- `server/ai-cost-policy.ts` (server; 46 symbols)
- `server/ai-router.ts` (server; 13 symbols)
- `server/app-qa-agent.ts` (server; 159 symbols, 11 imports)
- `server/assistant.ts` (server; 266 symbols, 24 imports, 3 routes)

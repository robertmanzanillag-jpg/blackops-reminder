...
Generated: 2026-06-21T05:29:58.376Z
...
| `server` | 89 | 86 | server:89 |
| `tests` | 53 | 51 | test:53 |
| `script` | 28 | 26 | script:28 |
| `.` | 23 | 17 | other:14, docs:8, package:1 |
| `docs` | 11 | 11 | docs:11 |
...
- `script/clippers-generate-owned-meme-sources.ts` (script; 19 symbols, 3 imports)
- `script/clippers-generate-owned-sports-streamer-sources.ts` (script; 22 symbols, 3 imports)
- `script/clippers-generate-owned-weekly-backlog-sources.ts` (script; 30 symbols, 3 imports)
...
- `server/ai-router.ts` (server; 9 symbols, 1 imports)
- `server/app-qa-agent.ts` (server; 152 symbols, 10 imports)
- `server/assistant.ts` (server; 233 symbols, 23 imports, 3 routes)
...
- `server/developer-autopilot.ts` (server; 73 symbols, 4 imports)
- `server/developer-health-inventory.ts` (server; 14 symbols, 2 imports)
- `server/dropshipping-ceo.ts` (server; 538 symbols, 6 imports)

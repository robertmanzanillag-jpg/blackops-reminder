...
Generated: 2026-07-20T09:29:21.660Z
...
| --- | ---: | ---: | --- |
| `client/src` | 122 | 120 | ui-component:55, client-page:23, client-component:21, other:13 |
| `server` | 96 | 92 | server:96 |
| `tests` | 69 | 66 | test:69 |
| `script` | 37 | 35 | script:37 |
| `.` | 26 | 18 | other:17, docs:8, package:1 |
| `server/ai-media-studio` | 14 | 14 | server:14 |
| `docs` | 12 | 12 | docs:12 |
| `server/replit_integrations` | 8 | 8 | server:8 |
| `docs/ai-media-studio` | 6 | 6 | docs:6 |
| `shared` | 3 | 3 | shared:3 |
...
- `client/src/pages/ai-media-studio.tsx` (client-page; 2 symbols, 9 imports)
...
- `server/ai-media-studio/domain.ts` (server; 1 symbols)
- `server/ai-media-studio/in-memory.ts` (server; 10 symbols, 3 imports)
- `server/ai-media-studio/index.ts` (server; 9 imports)
- `server/ai-media-studio/persistence/drizzle-media-job-repository.ts` (server; 9 symbols, 7 imports)
- `server/ai-media-studio/persistence/index.ts` (server; 2 imports)
...
- `server/ai-media-studio/providers/heygen-video-provider.ts` (server; 15 symbols, 3 imports)
- `server/ai-media-studio/routes.ts` (server; 32 symbols, 13 imports, 10 routes)
- `server/ai-media-studio/script-service.ts` (server; 13 symbols, 2 imports)
- `server/ai-media-studio/service.ts` (server; 21 symbols, 3 imports)
- `server/ai-media-studio/webhook-security.ts` (server; 6 symbols, 1 imports)

...
Generated: 2026-07-20T10:33:26.055Z
...
| `script` | 87 | 81 | script:87 |
| `tests` | 75 | 72 | test:75 |
| `.` | 27 | 17 | other:18, docs:8, package:1 |
| `revenue_workspace/approval-packets` | 17 | 17 | docs:17 |
| `marketing_workspace/video_intro` | 1764 | 12 | other:1764 |
| `docs` | 11 | 10 | docs:11 |
| `server/replit_integrations` | 8 | 8 | server:8 |
| `marketing_workspace` | 9 | 6 | docs:6, other:3 |
| `revenue_workspace/approvals` | 5 | 5 | docs:5 |
| `revenue_workspace/design-briefs` | 5 | 5 | docs:5 |
| `client/public` | 13 | 2 | other:13 |
| `marketing_workspace/videos` | 78 | 2 | other:77, docs:1 |
| `.agents/skills` | 2 | 1 | docs:1, other:1 |
| `.upm` | 1 | 1 | other:1 |
| `client` | 1 | 1 | other:1 |
| `revenue_workspace/plumber-website-demo` | 1 | 1 | other:1 |
| `revenue_workspace/public-verification` | 1 | 1 | docs:1 |
| `scripts` | 4 | 1 | script:4 |
| `shared` | 1 | 1 | shared:1 |
| `shared/models` | 1 | 1 | shared:1 |
| `tutorials/dropshipping-ceo-tutorial` | 8 | 1 | other:7, docs:1 |
| `.pnpm-store/v11` | 3 | 0 | other:3 |
...
- `tests/revenue-browser-scout-session-cli.test.ts`
...
- `tests/revenue-premium-website-work-order-cli.test.ts`
- `tests/revenue-public-candidate-evidence-verification-cli.test.ts`
- `tests/revenue-public-candidate-review-cli.test.ts`
- `tests/revenue-public-candidate-verification-artifact-cli.test.ts`
...
- `script/blackroom-daily-agent.ts` (script; 11 symbols, 1 imports)
- `script/build.mjs` (script; 4 symbols, 3 imports)
...
- `script/clippers-owned-tiktok-metricool-approval-pack.mjs` (script; 30 symbols, 2 imports)
- `script/clippers-owned-tiktok-metricool-proof-audit.mjs` (script; 27 symbols, 2 imports)
- `script/clippers-owned-tiktok-metricool-proof-templates.mjs` (script; 22 symbols, 2 imports)
- `script/clippers-owned-tiktok-metricool-upload-checklist.mjs` (script; 16 symbols, 2 imports)
- `script/clippers-owned-tiktok-metrics-audit.mjs` (script; 36 symbols, 2 imports)
- `script/clippers-owned-tiktok-metrics-templates.mjs` (script; 22 symbols, 2 imports)
- `script/clippers-owned-tiktok-weekly-batches.mjs` (script; 23 symbols, 2 imports)
- `script/clippers-real-tiktok-readiness-audit.mjs` (script; 52 symbols, 2 imports)
...
- `script/clippers-tiktok-account-launch-summary.mjs` (script; 18 symbols, 2 imports)
...
- `script/clippers-tiktok-go-live-handoff.mjs` (script; 20 symbols, 2 imports)
...
- `script/clippers-tiktok-refresh-all.mjs` (script; 3 symbols, 1 imports)
- `script/clippers-tiktok-report-index.mjs` (script; 19 symbols, 2 imports)
...
- `script/execute-radio-dj-action.ts` (script; 6 symbols, 2 imports)

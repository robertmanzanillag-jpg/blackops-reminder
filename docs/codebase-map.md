...
Generated: 2026-08-24T07:15:19.810Z
...
| `tests` | 108 | 105 | test:108 |
| `script` | 68 | 64 | script:68 |
| `docs` | 25 | 24 | docs:25 |
| `.` | 34 | 18 | other:22, docs:11, package:1 |
| `examples/clippers-motivation` | 11 | 11 | other:10, docs:1 |
...
- `tests/blackroom-remote-control.test.ts`: `/api/blackroom-agent`, `/api/blackroom-agent/analytics/import`, `/api/blackroom-agent/pause`, `/api/blackroom-agent/start`, `/blackroom`
...
## Test Inventory
- `tests/._dropshipping-ceo.test.ts`
- `tests/._radio-youtube-command.test.ts`
- `tests/._rate-limit.test.ts`
- `tests/._user-context.test.ts`
...
- `tests/metricool-analytics-sync.test.ts`
- `tests/metricool-tracking.test.ts`
- `tests/public-local-news.test.ts`
...
## Key Files
- `client/src/pages/._assistant.tsx` (client-page)
- `client/src/pages/._dropshipping-ceo.tsx` (client-page)
...
- `client/src/pages/local-news-public.tsx` (client-page; 73 symbols, 4 imports)
...
- `script/clippers-content-local-worker.mjs` (script; 66 symbols, 7 imports)
- `script/clippers-daily-watchdog.mjs` (script; 74 symbols, 3 imports)
...
- `script/clippers-youtube-uploader.mjs` (script; 89 symbols, 5 imports)

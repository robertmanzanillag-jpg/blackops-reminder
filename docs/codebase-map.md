...
Generated: 2026-07-22T11:45:13.856Z
...
- `tests/blackroom-remote-control.test.ts`: `/api/blackroom-agent`, `/api/blackroom-agent/pause`, `/api/blackroom-agent/start`, `/blackroom`
...
- `script/blackroom-local-worker.ts` (script; 74 symbols, 7 imports)
- `script/blackroom-remote-sync.mjs` (script; 16 symbols)
- `script/blackroom-worker-ledger.ts` (script; 27 symbols, 4 imports)

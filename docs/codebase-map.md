...
Generated: 2026-06-23T21:48:32.356Z
Repo: `/private/tmp/asistente-ytdlp-clean.wCVgIz/blackops-reminder`
...
| `server` | 92 | 89 | server:92 |
| `tests` | 56 | 54 | test:56 |
| `script` | 29 | 27 | script:29 |
...
- `script/clippers-record-owned-source-rights.ts` (script; 23 symbols, 3 imports)
...
- `server/assistant.ts` (server; 245 symbols, 24 imports, 3 routes)
